...
function Inicio(props) {
  const json1 = {
    ...
    '@type': 'Organization',
    name: 'codere',
    alternateName: ['codere españa', 'codere.es', 'codere es', 'codere spain', 'codere online'],
    ...
    contactPoint: {
      ...
      telephone: '[+34913432950]',
      email: 'apuestas@codere.com',
    },
    description:
      'Codere es la casa de apuestas deportivas y casino online #1 en España. Blackjack, ruleta online, slots y muchos tipos de deporte.',
    sameAs: [
