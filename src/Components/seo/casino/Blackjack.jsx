  ...
  return (
    <>
      <Helmet>
        ...
        />
        <link rel="canonical" href="https://www.codere.es/casino/blackjack" />
        <script type="application/ld+json">{JSON.stringify(json)}</script>
      </Helmet>

      <Floating text="¡Increíbles mesas en vivo!" juega={true} />
      <div
      ...
      <Container>
        <h1 className="mt-4">
          Juega al Blackjack y emociónate con el popular juego en línea
        </h1>
        <p>
          Codere te quiere hacer parte de esta aventura y adentrarte en el
          divertidísimo mundo de las partidas del 21 o mejor conocido como
          Blackjack en el <Link to="/casino">casino</Link>, ¡Ahora también
          Online! Pero ojo, queremos que esa aventura no sea sólo un momento de
          suerte y corazonadas, sino que además de disfrutarlo puedas petarlo en
          cada partida con todos los trucos y estrategias de este emocionante
          juego.
        </p>
        ...
        <div id={juegos.id} className="mt-4">
          ...
          <Row className="casino-row">
            {games.blackjack
              .slice(0, !props.flag ? games.blackjack.length : 4)
              .map((game, k) => (
        ...
        <div id={como_jugar.id} className="mt-4">
          <h2>{como_jugar.h2}</h2>
          <p>{como_jugar.text}</p>
