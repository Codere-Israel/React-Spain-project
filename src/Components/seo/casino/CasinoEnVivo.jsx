...
const CasinoEnVivo = (props) => {
  ...
  return (
    <>
      <Helmet>
        <title>
          El mejor Casino en Vivo de España » Juega Online | Codere®
        </title>
      ...
      <Floating text="Gran Diversión en Vivo" juega={true} />
      <div
      ...
      <Container>
        <div>
          ...
          <p>
            Los juegos de mesas de <Link to={"/casino"}>casino</Link> en vivo
            brindan una experiencia más inmersiva y realista. Puedes disfrutar
            de todas las ruletas en directo, blackjack y mucho más, con tu
            dispositivo móvil, en tu Tablet u ordenador.
          </p>
        </div>
        {!props.flag ? (
        ...
        <div id={chatea.id} className="mt-4">
          <h2>{chatea.h2}</h2>
          <p>{chatea.p}</p>
          <p>{chatea.p2}</p>
        </div>
